import { mdiAccount, mdiBallotOutline, mdiCursorDefault, mdiGithub, mdiMail, mdiUpload } from '@mdi/js'
...
const FormsPage = () => {
  return (
    <>
      ...
      <SectionTitle icon={mdiCursorDefault} title="Custom elements"></SectionTitle>
