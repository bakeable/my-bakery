...
curl -X POST http://localhost:4040/api/project/1/task \
     -H 'Content-Type: application/json' \
     -d '{"title": "BTW Aangifte", "started_timestamp": "2023-12-04 09:00:00", "project_id": 1, "finished_timestamp": "2023-12-05 10:00:00", "hours": 1, "priority": 10, "status": "done", "description": "De BTW aangifte van BakeAble"}'
